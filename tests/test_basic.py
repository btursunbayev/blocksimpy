...
def test_actual_simulation():
    ...
    cmd = [
        ...
        str(script_path),
        "--blocks",
        "2",  # Mine just 2 blocks
        "--miners",
        "1",  # Single miner
        "--wallets",
        "1",  # Single wallet
        "--transactions",
        "3",  # 3 transactions total
        "--blocktime",
        "0.1",  # Very fast blocks
    ]
    ...
    try:
        ...
        raise AssertionError(f"Simulation error: {e}")
