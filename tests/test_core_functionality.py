...
def test_block_functionality():
    ...
    from blockchain_simulator.core.block import Block
    from blockchain_simulator.utils.formatting import HEADER_SIZE
...
def test_mining_components():
    ...
    from blockchain_simulator.core.miner import Miner
...
def test_configuration_loading():
    ...
    from blockchain_simulator.config.config_loader import load_config
